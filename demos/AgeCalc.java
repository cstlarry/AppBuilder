...
public class AgeCalc extends Application {
    ...
    private void setup() {
        ...
        setFormPrompts("Name", "Year of last birthday","Birth year");
    ...
    public void run() {
        ...
        int yearLastBDay = Integer.parseInt(getField(1));
        int birthYear = Integer.parseInt(getField(2));

        int age = yearLastBDay-birthYear;

        outputln(String.format("%s is %d years old", name, age));
